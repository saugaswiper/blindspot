  ...
  return (
    <div id="printable-report" style={{ display: "none" }}>
      ...
      <section className="report-prisma-section">
        ...
        {(() => {
          ...
          const knownSources = prismaData.sources.filter((s) =>
            ["PubMed", "OpenAlex", "Europe PMC", "Scopus", "Semantic Scholar"].includes(s.name)
          );
      ...
      <div className="report-footer">
        <p>
          Results sourced from PubMed, OpenAlex, Europe PMC, Scopus, and Semantic Scholar. AI-generated analysis (gap analysis section)
