  ...
  return (
    <main className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <section className="max-w-3xl mx-auto px-4 pt-8 sm:pt-16 pb-8 sm:pb-12 text-center">
        <h1 className="text-3xl sm:text-4xl font-bold text-[#1e3a5f] dark:text-blue-300 leading-tight" suppressHydrationWarning>
      ...
      <section className="max-w-2xl mx-auto px-4 pb-16">
        <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-6">
          ...
          <Suspense fallback={<div className="h-24 bg-gray-50 dark:bg-gray-800 rounded-lg animate-pulse" />}>
            <TopicInput />
          </Suspense>
        </div>
      ...
      <section className="bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700">
        <div className="max-w-4xl mx-auto px-4 py-14">
          <h2 className="text-xl font-semibold text-[#1e3a5f] dark:text-blue-300 text-center mb-10">
            How it works
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={step} className="text-center">
                <div className="w-10 h-10 rounded-full bg-[#1e3a5f] dark:bg-blue-700 text-white text-sm font-bold flex items-center justify-center mx-auto mb-3">
                  {step}
                </div>
      ...
      <footer className="border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900">
        <div className="max-w-5xl mx-auto px-4 py-6 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-gray-600 dark:text-gray-400">
          <span suppressHydrationWarning>Blindspot &copy; {new Date().getFullYear()}</span>
          <div className="flex gap-4">
            <a href="/about" className="hover:text-gray-800 dark:hover:text-gray-200">About &amp; Methodology</a>
            <a href="/privacy" className="hover:text-gray-800 dark:hover:text-gray-200">Privacy</a>
            <TourRestartButton />
          </div>
        </div>
      </footer>
